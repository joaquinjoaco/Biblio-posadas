...
import { SentOrderColumn } from "./columns";
...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    return (
        <div className="flex items-center gap-x-2">
            <ReassignModal isOpen={open} onClose={() => setOpen(false)} initialData={data} />
            <TooltipWrapper
                content="Reasignar"
            ...
            >
                <Link
                    className="inline-flex justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 w-10 mt-[2px]"
